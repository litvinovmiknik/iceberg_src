...
const fileSources = {
    ...
    sass: `@import '../../styles/utils/vars'${newLineChar}${newLineChar}.{blockName}${newLineChar}\tdisplay: block${newLineChar}\t` // Add source in sass block file when creating this file
};
